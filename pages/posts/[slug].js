    ...
    return(
        <div>
            ...
            <div className='MAIN CONTENT flex flex-col items-start justify-center w-full max-w-3xl mx-auto mb-16'>
                <h1 className='text-5xl font-bold mx-8 mt-5 md:mt-0'>{post.title}</h1>
                <p className='text-gray-500 py-3 mx-8'>{post.publishedOn}</p>
                <div className='POSTCONTENT mx-8 space-y-8 text-gray-500 leading-relaxed text-md' 
