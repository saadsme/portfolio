  ...
  return (
    ...
    <div className=' flex justify-between items-center my-6 md:m-0 md:hidden' >
        ...
        <div className="mx-auto md:justify-between md:max-w-4xl md:w-full md:my-12 mb-8 dark:text-gray-100 text-gray-700 md:flex">
            <div className={`flex flex-col md:justify-start md:items-center md:flex-row md:pt-0 text-lg space-y-2 md:space-y-0 md:mr-6 absolute md:pl-0 pl-6 transition-all duration-250 md:static  rounded-2xl md:z-auto z-[1000] py-4 md:pb-0  left-5 right-5 ${open ? 'top-20' : 'top-[-490px]'}`}>
