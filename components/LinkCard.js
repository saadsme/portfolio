...
const LinkCard = ({text, link, icon}) => {
  return (
    <a href={link} target='_blank' className='hover:cursor-pointer bg-black text-white dark:bg-white text-md dark:text-black rounded-full px-6 py-4 w-full flex justify-between'>
